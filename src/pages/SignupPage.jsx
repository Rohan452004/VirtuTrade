...
function SignUpPage() {
  ...
  const handleSendOtp = async () => {
    ...
    console.log(`${import.meta.env.VITE_APP_WEB_URL}/api/users/sendotp`);
    ...
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_APP_WEB_URL}/api/users/sendotp`,
  ...
  const handleSignUp = async () => {
    ...
    try {
      ...
      const res = await axios.post(
        `${import.meta.env.VITE_APP_WEB_URL}/api/users/signup`,
        {
          ...formData,
          otp,
        }
